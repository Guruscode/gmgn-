      ...
      <div className="border-t border-dex-border pt-4">
        ...
        <div className="mb-3">
          ...
          <input
            ...
            className="w-full bg-gray-700 border border-dex-border rounded p-2 text-dex-text-primary"
          />
        </div>
        ...
        <button
          ...
          className="w-full bg-blue-800 hover:bg-blue-600 text-white rounded py-2"
        >
          Add Wallet
        </button>
      </div>
